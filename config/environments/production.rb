Presentation::Application.configure do
  ...
  config.action_controller.relative_url_root = "/oze"
  ...
  config.middleware.use ExceptionNotifier,
    :email_prefix => "[ERROR] Presentation",
    :sender_address => %{"Errors" <richard.lapis@gmail.com>},
    :exception_recipients => %w{richard.lapis@gmail.com}
end
